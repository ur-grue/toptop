...
_toptop() {
    ...
    opts="-t --tick --theme --tree --no-tree --ai --remote --remote-cmd --config --no-save --list-themes --snapshot --diagnose --export --serve-metrics --alert-vram --alert-kv --alert-queue -h --help -V --version"
